    ...
    <section id="search_members">
        <div class="box">
            ...
            <div id="member_search" class="overlay">
                <div class="popup">
                    <a class="close" href="#search_memebers">&times;</a>
                    <div class="content">
                        <h1>Member Info</h1>
                        <?php
                        if (isset($_POST['search_id'])) {
                            ...
                            if ($count == "0") {
                                ...
                                while ($row_member = mysqli_fetch_array($query_member)) {
                                    ...
                                    echo '<h2>ID: <span>' . $row_member['id'] . '</span><br>Name: <span>' .  $row_member['name'] . '</span><br> email: <span>' . $row_member['email'] . '</span></h2><br>';
                                }
                            }
                            ...
                            $q = $_POST['email'];
                            $query_member = mysqli_query($conn, "SELECT * FROM members WHERE email = '$q';");
                            $count = mysqli_num_rows($query_member);
                            if ($count == "0") {
                                exit('<h2>No result found!</h2>');
                            } else {
